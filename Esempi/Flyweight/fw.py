...
class FW():
    ...
    def op(self, itsOwnState: list,tipo: type, file: str):
...
if __name__ == "__main__":
    ...
    add(
        factory, "HJ453FT", "Ada Klein", "BMW", "M5", "rossa")

    add(
        factory, "JK323OL", "Donald Summerfield", "BMW", "X1", "rossa")
